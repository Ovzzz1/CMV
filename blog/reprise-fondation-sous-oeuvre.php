 ...
 <section class="article-hero" style="background-image: url('<?php echo $article_meta['image']; ?>');">
  <div class="article-hero-content">
   <nav class="breadcrumb">
    ...
    <span>/</span>
    <a href="<?php echo BASE_URL . $current_cat; ?>">Rénovation</a>
    <span>/</span>
    <span>Reprise fondation sous oeuvre</span>
   </nav>
   <div class="article-tags">
    <span class="tag">Fondations</span>
    <span class="tag">Structure</span>
    <span class="tag">Gros œuvre</span>
   </div>
   <h1>Reprise fondation sous oeuvre :<br><span class="h1-accent">quand et comment consolider vos fondations (2026)</span></h1>
 ...
 <div class="article-layout">
  <aside class="sidebar-left">
   <div class="sidebar-widget">
    <h3>Univers Rénovation</h3>
    <ul class="category-list">
     <?php foreach ($other_cats as $slug => $cat): ?>
     <li><a href="<?php echo BASE_URL . $slug; ?>"><?php echo $cat['name']; ?></a></li>
     <?php endforeach; ?>
    </ul>
   </div>
  </aside>
  ...
  <div class="article-container">
   ...
   <p>Plusieurs facteurs influencent le coût final :</p>
   ...
   <p>Selon votre situation, vous pouvez bénéficier d'aides :</p>

<?php
// published: 2026-05-02 08:00
/**
 * reparer-gouttiere-zinc-fuit.php
 * Article : Comment réparer une gouttière en zinc qui fuit ? Guide complet
...
// ─── HERO ─────────────────────────────────────────────────────────────────────
'hero' => [
    'breadcrumb' => 'Réparer gouttière zinc',
    'tags'       => ['Gouttière zinc', 'Étanchéité', 'Bricolage toiture', 'Zinguerie'],
    'h1'         => '<h1>Comment réparer une gouttière en zinc qui fuit :<br><span class="h1-accent">Guide complet</span></h1>',
],
...
// ─── TOC ──────────────────────────────────────────────────────────────────────
'toc' => [
    ['anchor' => '#pourquoi',             'label' => '1. Pourquoi ma gouttière en zinc fuit-elle ?'],
    ['anchor' => '#tableau-comparatif',   'label' => '2. Quelle solution choisir ? (Tableau comparatif)'],
    ['anchor' => '#methode-sans-soudure', 'label' => '3. Réparer sans soudure'],
    ['anchor' => '#methode-soudure',      'label' => '4. Réparer avec soudure à l\'étain'],
    ['anchor' => '#section-pro',          'label' => '5. Quand faire appel à un professionnel ?'],
    ['anchor' => '#entretien',            'label' => '6. Entretien pour éviter les réparations fréquentes'],
    ['anchor' => '#ux-outil',             'label' => '⚙️ Outil : Diagnostic de votre type de réparation'],
    ['anchor' => '#faq',                  'label' => 'FAQ, Questions fréquentes'],
],

// ─── CONTENU ÉDITORIAL (HTML brut, liens avec BASE_URL) ───────────────────────
'content' => <<<HTML

<h2 id="pourquoi">1. Pourquoi ma gouttière en zinc fuit-elle ?</h2>
...
<h3>Comment localiser précisément la fuite</h3>
...
<h2 id="tableau-comparatif">2. Quelle solution choisir ? Tableau comparatif</h2>
...
<div class="table-wrapper">
    <table class="content-table">
        ...
        <tbody>
            <tr>
                <td><strong>Petite fissure (&lt; 5 mm)</strong></td>
                <td>Mastic spécial zinc (ex : Soudal Zinc Fix)</td>
                <td>⭐ Facile</td>
                <td>3 à 5 ans</td>
                <td>~15 €</td>
            </tr>
            <tr>
                <td><strong>Jonction / joint qui fuit</strong></td>
                <td>Mastic polyuréthane + nettoyant zinc</td>
                <td>⭐ Facile</td>
                <td>3 à 5 ans</td>
                <td>~20 €</td>
            </tr>
            <tr>
                <td><strong>Trou moyen (5-20 mm)</strong></td>
                <td>Bande bitumeuse à froid ou résine armée</td>
                <td>⭐⭐ Moyen</td>
                <td>5 à 10 ans</td>
                <td>~25-40 €</td>
            </tr>
            <tr>
                <td><strong>Soudure ouverte / raccord lâché</strong></td>
                <td>Soudure à l'étain (fer à souder de couvreur)</td>
                <td>⭐⭐⭐ Technique</td>
                <td>15 à 20 ans</td>
                <td>~50-80 € (équipement)</td>
            </tr>
            <tr>
                <td><strong>Zone très corrodée / trou &gt; 3 cm</strong></td>
                <td>Remplacement du tronçon (pro recommandé)</td>
                <td>⭐⭐⭐ Expert</td>
                <td>30-40 ans</td>
                <td>30-60 €/ml (pose)</td>
            </tr>
...
<h2 id="methode-sans-soudure">3. Réparer une gouttière en zinc sans soudure</h2>

<p>C'est la méthode plébiscitée par les bricoleurs du dimanche : aucun outil spécifique, pas de chalumeau, pas de risque de brûlure. Deux options selon la taille de la fissure.</p>
...
<ol style="margin-bottom: 20px; padding-left: 20px;">
    ...
    <li><strong>Laissez sécher 24h</strong> avant toute pluie ou test d'eau.</li>
</ol>

<h3 id="methode-sans-soudure-bitume">Option B — Bande bitumeuse ou résine armée (trou ou zone plus large)</h3>

<p>Pour un trou de 5 à 20 mm ou une zone de zinc fatigué sur plusieurs centimètres, la bande bitumeuse autoadhésive (type Sika ou Parafor) ou la résine d'étanchéité armée sont nettement plus efficaces que le mastic seul.</p>

<ol style="margin-bottom: 20px; padding-left: 20px;">
    <li><strong>Brossez la surface</strong> avec une brosse métallique pour retirer toute oxydation et assainir la zone.</li>
    <li><strong>Dégraissez</strong> avec du nettoyant zinc ou de l'acétone, puis laissez sécher complètement.</li>
    <li><strong>Si bande bitumeuse</strong> : coupez un morceau dépassant largement la zone (5 cm de marge de chaque côté). Chauffez légèrement le côté goudronné au sèche-cheveux pour l'assouplir, puis appliquez en appuyant du centre vers les bords pour chasser les bulles d'air.</li>
    <li><strong>Si résine armée</strong> : appliquez une première couche au pinceau, posez une toile de verre, puis recouvrez d'une seconde couche de résine. Attendez le séchage complet entre les deux couches.</li>
    <li><strong>Vérifiez les bords</strong> : appuyez fermement sur tout le pourtour. Un bord décollé = point de reprise de fuite assuré.</li>
</ol>

<h2 id="methode-soudure">4. Réparer une gouttière en zinc avec soudure (méthode durable)</h2>
...
<blockquote class="article-blockquote">
    <p>"Si vous n'avez jamais soudé, entraînez-vous d'abord sur une chute de zinc avant de travailler sur la gouttière en place."</p>
</blockquote>

<h2 id="section-pro">5. Quand faut-il faire appel à un zingueur professionnel ?</h2>
    ...
    <table class="content-table">
        <thead>
            <tr>
                ...
                <th>Prix estimé (fournitures + main d'œuvre)</th>
            </tr>
        </thead>
        <tbody>
            <tr><td><strong>Réparation simple (mastic / soudure locale)</strong></td><td>50 € – 150 €</td></tr>
            <tr><td><strong>Remplacement d'un tronçon de zinc</strong></td><td>30 € – 60 € par mètre linéaire</td></tr>
            <tr><td><strong>Remplacement de la totalité des gouttières</strong></td><td>500 € – 2 000 € selon la longueur</td></tr>
        </tbody>
    </table>
</div>

<p>Ces tarifs varient selon la région et l'accessibilité du chantier. Demandez toujours plusieurs devis.</p>

<h2 id="entretien">6. Comment éviter les réparations fréquentes ? (Entretien)</h2>

<p>Une gouttière en zinc correctement entretenue peut durer 30 à 40 ans. La principale cause d'usure prématurée est l'eau stagnante liée aux bouchons.</p>
...
'ux' => [
    ...
    'steps' => [
        ['question' => 'Quelle est l\'ampleur de la fuite ?', 'options' => [
            ...
            ['label' => 'Trou moyen ou joint / jonction qui fuit (5 à 20 mm)', 'value' => 'type-trou'],
            ['label' => 'Grosse perforation ou zinc corrodé sur plusieurs cm', 'value' => 'type-gros'],
        ]],
        ['question' => 'Avez-vous un fer à souder ou un chalumeau ?', 'options' => [
            ['label' => 'Oui, je suis à l\'aise avec la soudure', 'value' => 'soudure-oui'],
            ['label' => 'Non, je préfère une solution à froid', 'value' => 'soudure-non'],
        ]],
        ['question' => 'La zone est-elle accessible et sécurisée ?', 'options' => [
            ['label' => 'Oui, échelle sécurisée ou accessible depuis le sol', 'value' => 'accessible'],
            ['label' => 'Non, la gouttière est haute ou difficile d\'accès', 'value' => 'inaccessible'],
        ]],
    ],
    ...
    'js_logic'      => <<<JS
        ...
        } else if (userAnswers.step2 === 'soudure-oui') {
            successBox.style.display = 'block';
            resultText.innerHTML = '<strong>Réparation à la soudure à l\'étain.</strong> C\'est la méthode la plus durable pour votre type de fuite. Suivez les étapes de la section 4 ci-dessus.';
        } else if (userAnswers.step1 === 'type-trou') {
            successBox.style.display = 'block';
            resultText.innerHTML = '<strong>Bande bitumeuse à froid ou résine armée.</strong> Idéal pour votre trou moyen, sans soudure. Suivez les étapes de l\'option B (section 3).';
        } else {
            successBox.style.display = 'block';
            resultText.innerHTML = '<strong>Mastic spécial zinc (Soudal Zinc Fix).</strong> Rapide, efficace, sans chalumeau. Suivez les étapes de l\'option A (section 3).';
        }
JS,
],
...
// ─── FAQ (min 3) ──────────────────────────────────────────────────────────────
'faq' => [
    ['q' => 'Est-ce que le silicone classique tient sur le zinc ?',
     'a' => 'Non. Le silicone sanitaire ou ménager n\'est pas prévu pour l\'exposition aux UV et à l\'eau de ruissellement en extérieur. Il se décolle en moins d\'un an. Utilisez impérativement un mastic polyuréthane ou polymère conçu pour le zinc, comme le <strong>Soudal Zinc Fix</strong> ou un mastic de couverture certifié ATEX.'],
...
// ─── BLOCS DE FIN ─────────────────────────────────────────────────────────────
'author_phrase' => 'Avec plus de 20 ans d\'interventions en zinguerie et couverture, Philippe partage ici les méthodes qu\'il recommande à ses clients pour une réparation durable, sans mauvaises surprises.',

'conclusion' => [
    'title' => 'Pas sûr de la méthode adaptée à votre gouttière ?',
    'text'  => 'Une mauvaise réparation peut aggraver la fuite ou abîmer la charpente sous-jacente. Mieux vaut un diagnostic rapide par un professionnel.',

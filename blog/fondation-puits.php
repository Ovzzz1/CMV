    ...
    <div class="article-layout">
        ...
        <div class="article-container">
            ...
            <p class="article-intro">Vous construisez une extension ou votre terrain présente un sol peu stable ? Les
                <strong>puits de fondation</strong> offrent une solution fiable et économique pour soutenir votre
                ouvrage. Moins connus que les pieux, ils méritent pourtant qu'on s'y intéresse. Découvrez quand les
                utiliser, comment les réaliser et combien ça coûte.</p>
            ...
            <div class="article-content">
                ...
                <div class="tldr-box">
                    ...
                    <ul>
                        <li><strong>Profondeur puits fondation :</strong> 2 à 5 mètres selon la qualité du sol porteur.
                        </li>
                        ...
                        <li><strong>Délai réalisation :</strong> 2 à 4 jours pour 8 à 12 puits sur un chantier standard.
                        </li>
                        <li><strong>Alternative aux pieux :</strong> 30 à 50 % moins cher, idéal pour les extensions
                            légères.</li>
                    </ul>
                </div>
                ...
                <p>Un <strong>puits de fondation</strong> est un élément de fondation profonde creusé dans le sol pour
                    atteindre une couche porteuse stable. Contrairement aux <strong><u><a
                                href="<?php echo BASE_URL; ?>fondation-garage">fondations de garage
                                classiques</a></u></strong> qui reposent sur des semelles filantes, le puits descend
                ...
                <div
                    style="background-color: var(--color-light); border-left: 4px solid var(--color-primary); padding: 1.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0;">
                    <strong>En clair :</strong> Le puits de fondation joue le rôle d'un pilier enterré. Il traverse les
                    couches de sol faible pour s'ancrer dans le roc ou l'argile compacte situés en profondeur.
                </div>
                ...
                <div class="table-wrapper">
                    <table class="content-table">
                        ...
                        <tbody>
                            <tr>
                                <td><strong>Semelle filante</strong></td>
                                <td>50 à 80 cm</td>
                                <td>Sol stable, construction standard</td>
                                <td>80 à 120 €/ml</td>
                            </tr>
                            <tr>
                                <td><strong>Puits de fondation</strong></td>
                                <td>2 à 5 m</td>
                                <td>Sol faible, extension légère</td>
                                <td>80 à 150 €/ml creusé</td>
                            </tr>
                            <tr>
                                <td><strong>Pieu foré</strong></td>
                                <td>3 à 15 m</td>
                                <td>Sol très compressible, charges lourdes</td>
                                <td>150 à 400 €/ml</td>
                            </tr>
                            <tr>
                                <td><strong>Pieu battu</strong></td>
                                <td>6 à 20 m</td>
                                <td>Grands ouvrages, viaducs</td>
                                <td>200 à 500 €/ml</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <p>Les <strong>semelles</strong> conviennent aux terrains stables. Les <strong>puits</strong> prennent
                    le relais quand le sol de surface est trop faible mais que la couche porteuse reste accessible
                    (moins de 5 m). Les <strong>pieux</strong> deviennent nécessaires pour les charges très lourdes ou
                    les sols profondément mauvais.</p>

                <h3>Matériaux utilisés</h3>
                <p>Un puits de fondation standard se compose de trois matériaux :</p>

                <ul class="custom-list">
                    <li><strong>Béton :</strong> Dosé à 350 kg/m³ minimum (B25). Le <strong><u><a
                ...
                <div
                    style="background-color: var(--color-light); border-left: 4px solid var(--color-primary); padding: 1.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0;">
                    <strong>En clair :</strong> La cage d'armatures est le squelette métallique du puits. Elle empêche
                    le béton de se fissurer sous la pression du sol ou des charges de l'ouvrage.
                </div>
                ...
                <p>C'est le cas le plus fréquent. Votre terrain présente une couche de remblai, de tourbe ou d'argile
                    molle sur les premiers mètres. Ces sols ne supportent pas le poids d'une construction. Le puits
                    traverse ces couches instables pour s'ancrer dans le sol porteur.</p>

                <p>Signes qui doivent vous alerter :</p>
                <ul class="custom-list">
                    <li><strong>Végétation :</strong> Présence de roseaux, de saules ou de carex indique un sol humide
                        et peu stable.</li>
                    <li><strong>Historique :</strong> Ancienne zone marécageuse, carrière comblée ou décharge.</li>
                    <li><strong>Étude de sol :</strong> Rapport G2 (géotechnique) indiquant une portance insuffisante en
                        surface.</li>
                </ul>

                <h3>Extension sur fondations existantes</h3>
                <p>Vous agrandissez votre maison et la nouvelle partie doit s'appuyer sur des fondations différentes de
                    l'existant ? Les puits permettent de créer des points d'appui sans démolir les fondations actuelles.
                </p>

                <p>Cette technique, appelée <strong><u><a
                                href="<?php echo BASE_URL; ?>reprise-fondation-sous-oeuvre">reprise en
                                sous-œuvre</a></u></strong>, consiste à soutenir temporairement l'ouvrage existant
                    pendant qu'on creuse et coule les puits sous les murs porteurs. Une fois le béton durci, on
                    transfère progressivement les charges sur les nouveaux appuis.</p>

                <div
                    style="background-color: var(--color-light); border-left: 4px solid var(--color-primary); padding: 1.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0;">
                    <strong>En clair :</strong> La reprise en sous-œuvre, c'est opérer sous un mur déjà construit sans
                    qu'il s'effondre. Ça demande du matériel spécifique (vérins, cintres) et de l'expérience.
                </div>

                <h3>Décaissement limité</h3>
                <p>Sur un terrain en pente ou en limite de propriété, vous ne pouvez pas creuser de grandes tranchées.
                    Les puits de fondation permettent de foncer verticalement sans toucher au voisinage.</p>

                <p>C'est particulièrement utile pour les extensions en limite séparative où la réglementation impose un
                    respect strict des emprises au sol.</p>

                <h3>Zone inondable ou proche de nappe</h3>
                <p>Dans les zones où la nappe phréatique est haute, une semelle classique risquerait de flotter ou de
                    subir des mouvements dus aux variations du niveau d'eau. Le puits, ancré en profondeur, reste stable
                ...
                <p>Avant de creuser, le géomètre ou le chef de chantier trace l'emplacement exact de chaque puits selon
                    le plan de structure. On utilise un théodolite ou un laser pour garantir l'alignement.</p>
                ...
                <p>L'espacement entre puits dépend de la charge à supporter. Pour une extension légère (bois, ossature
                    métallique), on espacera de 2,50 à 3 mètres. Pour une maison en parpaings, on réduira à 1,80 à 2,20
                    mètres.</p>
                ...
                <p>Un ouvrier équipé d'une pelle, d'un pic et d'un seau descend dans le trou au fur et à mesure. On
                    évacue la terre avec une benne et un treuil. Cette méthode reste économique pour de petits chantiers
                    (4 à 6 puits) et permet une grande précision.</p>

                <p><strong>À la pelleteuse (au-delà de 2,50 m) :</strong></p>
                <p>Godet spécial étroit (30 à 40 cm de large) monté sur une pelleteuse de 8 à 12 tonnes. Plus rapide,
                    mais nécessite un accès suffisant et un sol stable pour la machine. Compter 20 à 30 minutes par
                    puits contre 2 à 3 heures à la main.</p>

                <div
                    style="background-color: #fbe3cb; border-left: 4px solid #e74c3c; padding: 1.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0; color: #3e2e1f;">
                    <strong>Attention :</strong> Au-delà de 1,20 m de profondeur, les parois doivent être étayées ou le
                    puits réalisé en blindage pour éviter les effondrements. Le risque d'accident est réel.
                </div>

                <h3>Ferraillage et cage d'armatures</h3>
                <p>Une fois le trou creusé et nettoyé, on descend la cage d'armatures préfabriquée. Elle se compose de :
                </p>
                ...
                <ul class="custom-list">
                    ...
                    <li><strong>Longueur :</strong> La cage dépasse de 30 à 50 cm au-dessus du sol pour s'ancrer dans le
                        futur mur ou la longrine</li>
                </ul>

                <p>On positionne des cales en béton ou des boules plastiques au fond du trou pour maintenir la cage à 5
                    cm du sol. Cet enrobage protège l'acier de la corrosion.</p>
                ...
                <p>Le coulage se fait par benne ou pompe à béton selon l'accessibilité. On vibrte le béton avec une
                    aiguille vibrante pour éliminer les bulles d'air et assurer le contact parfait avec le sol.</p>

                <h3>Reprise en sous-œuvre</h3>
                <p>Quand on doit créer des fondations sous un mur existant, la procédure est plus complexe :</p>

                <ol>
                    <li><strong>Étaiement :</strong> On installe des vérins et des poutres de répartition pour soutenir
                        le mur</li>
                    <li><strong>Découpe :</strong> On ouvre des tranchées dans les fondations existantes tous les 1,50 à
                        2 mètres</li>
                ...
                <p>Cette opération demande un calcul de structure pour dimensionner les étais. Ne tentez pas ça sans
                    professionnel.</p>
                ...
                <ul class="custom-list">
                    ...
                    <li><strong>Accessibilité :</strong> Possible en terrain difficile, près des constructions
                        existantes</li>
                ...
                <div class="table-wrapper">
                    <table class="content-table">
                        ...
                        <tbody>
                            <tr>
                                <td>Extension bois/ossature, sol faible < 4 m</td>
                                <td><strong>Puits</strong></td>
                                <td>Économique, suffisant</td>
                            </tr>
                            <tr>
                                <td>Maison plain-pied en maçonnerie</td>
                                <td><strong>Puits</strong></td>
                                <td>Charge supportée, coût maîtrisé</td>
                            </tr>
                            <tr>
                                <td>Étage supplémentaire sur existant</td>
                                <td><strong>Pieux</strong></td>
                                <td>Charge trop lourde</td>
                            </tr>
                            <tr>
                                <td>Sol pourri sur > 5 mètres</td>
                                <td><strong>Pieux</strong></td>
                                <td>Profondeur nécessaire</td>
                            </tr>
                            <tr>
                                <td>Zone à fort risque sismique</td>
                                <td><strong>Pieux</strong></td>
                                <td>Meilleure résistance horizontale</td>
                            </tr>
                            <tr>
                                <td>Très grand nombre de points d'appui</td>
                                <td><strong>Pieux</strong></td>
                    ...
                    <table class="content-table">
                        <thead>
                            <tr>
                                <th>Type de sol</th>
                                <th>À la main</th>
                                <th>À la pelleteuse</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><strong>Terre végétale / sable</strong></td>
                                <td>60 à 80 €/ml</td>
                                <td>40 à 60 €/ml</td>
                            </tr>
                            <tr>
                                <td><strong>Argile compacte</strong></td>
                                <td>80 à 120 €/ml</td>
                                <td>60 à 90 €/ml</td>
                            </tr>
                            <tr>
                                <td><strong>Sol rocheux / caillouteux</strong></td>
                                <td>120 à 180 €/ml</td>
                                <td>90 à 140 €/ml</td>
                            </tr>
                        </tbody>
                ...
                <ul class="custom-list">
                    <li><strong>Béton B25 :</strong> 0,20 m³ par mètre de profondeur × 120 €/m³ = <strong>24
                            €/ml</strong></li>
                    <li><strong>Ferraillage :</strong> Cage préfabriquée ou façonnée sur place = <strong>15 à 25
                            €/ml</strong></li>
                    <li><strong>Transport et pompage :</strong> Forfait selon distance = <strong>200 à 400 €</strong>
                    </li>
                </ul>
                ...
                <div class="table-wrapper">
                    <table class="content-table">
                        <thead>
                            <tr>
                                <th>Poste</th>
                                <th>Puits de fondation</th>
                                <th>Pieux forés</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><strong>Étude de sol</strong></td>
                                <td>800 €</td>
                                <td>800 €</td>
                            </tr>
                            <tr>
                                <td><strong>Excavation / forage</strong></td>
                                <td>2 400 €</td>
                                <td>4 800 €</td>
                            </tr>
                            <tr>
                                <td><strong>Béton + ferraillage</strong></td>
                                <td>1 200 €</td>
                                <td>1 600 €</td>
                            </tr>
                            <tr>
                ...
                <p>Les puits représentent une économie de <strong>35 à 40 %</strong> par rapport aux pieux sur ce type
                    de chantier. L'écart se creuse sur les petits ouvrages où le déplacement d'une foreuse est coûteux.
                </p>
                ...
                <p>Non, pas d'autorisation spécifique pour les puits de fondation eux-mêmes. En revanche, votre projet
                    global (extension ou construction neuve) nécessite un permis de construire ou une déclaration
                    préalable selon la surface. L'étude de sol G1 ou G2 (obligatoire pour tout permis) déterminera si
                    les puits sont adaptés à votre terrain.</p>

                <h3>Quelle profondeur maximale pour un puits creusé à la main ?</h3>
                <p>La limite technique se situe autour de 3 à 3,50 mètres. Au-delà, l'évacuation de la terre devient
                    problématique et le risque d'effondrement des parois augmente. Pour les profondeurs supérieures, on
                    utilise une pelleteuse avec godet étroit ou on opte pour des pieux forés.</p>
                ...
                <p>Le béton atteint 50 % de sa résistance en 7 jours et 100 % en 28 jours. En pratique, on peut poser
                    les longrines et monter les murs au bout de <strong>7 à 10 jours</strong> si le temps est sec et
                    tempéré. En hiver ou par temps humide, compter 14 jours minimum.</p>

                <h3>Les puits de fondation sont-ils couverts par la garantie décennale ?</h3>
                <p>Oui, les puits de fondation entrent dans le périmètre de la garantie décennale comme tout élément de
                    structure. L'entrepreneur qui les réalise est tenu responsable pendant 10 ans en cas de désordre
                    affectant la solidité de l'ouvrage. Conservez bien votre contrat et les justificatifs de l'étude de
                    sol.</p>

                <h3>Quel dosage béton pour couler les puits ?</h3>
                <p>Le béton des puits doit atteindre une classe minimale C25/30, soit 350 kg de ciment par m³. En sol
                    humide ou proche d'une nappe, préférez un C30/37 avec adjuvant hydrofuge. Notre guide sur le <a
                        href="https://www.cemarenov.fr/dosage-beton-fondation">dosage béton fondation</a> détaille les
                    proportions exactes au seau et au m³ selon la classe de résistance visée.</p>
                ...
                <p>Non. Pour un muret de clôture ou de jardin, les puits sont surdimensionnés et coûteux. Une semelle
                    filante hors-gel suffit amplement. Notre guide <a
            ...
            <div class="author-box-bottom">
                ...
                <div class="author-box-content">
                    ...
                    <p>Avec plus de 20 ans d'expérience sur les chantiers, Philippe vous partage ses conseils concrets
                        et sans langue de bois. Spécialiste des fondations et des reprises en sous-œuvre.</p>

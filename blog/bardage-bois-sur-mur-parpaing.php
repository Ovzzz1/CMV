    ...
    <div class="article-layout">
        ...
        <div class="article-container">
            ...
            <p class="article-intro">
                Poser un bardage bois sur un mur en parpaings, c'est l'une des transformations les plus efficaces pour rénover une façade et la protéger durablement. Mais le parpaing est un support minéral hydrophile et souvent creux : la préparation du mur, le choix des fixations et la création d'une lame d'air ne souffrent aucune improvisation. Ce guide vous détaille chaque étape, de l'état des lieux au vissage final, en conformité avec le DTU 41.2.
            </p>
            ...
            <div class="article-content">
                ...
                <div class="tldr-box">
                    ...
                    <ul class="custom-list">
                        <li><strong>Support à diagnostiquer :</strong> Vérifiez la planéité (règle de 2 m), l'absence d'humidité et la solidité des alvéoles avant toute fixation.</li>
                        <li><strong>Chevilles adaptées :</strong> Sur parpaing creux, utilisez impérativement des chevilles à frapper longues (100–140 mm), jamais des chevilles à expansion simples.</li>
                        <li><strong>Lame d'air obligatoire :</strong> L'ossature en tasseaux (60 cm d'entraxe, 27×40 mm minimum) doit laisser circuler l'air derrière les lames.</li>
                        <li><strong>Inox partout :</strong> Vis A2 en milieu standard, A4 en bord de mer. L'acier standard tache le bois et casse en 2 à 3 ans.</li>
                        <li><strong>Essence de bois :</strong> Douglas (Classe 3) pour le meilleur rapport qualité/prix, Mélèze ou Red Cedar pour les climats exigeants.</li>
                        <li><strong>3 erreurs fatales :</strong> Pas de lame d'air, vis non-inox, lames trop serrées sans jeu de dilatation.</li>
                    </ul>
                </div>
                ...
                <p>Avant de fixer le moindre tasseau, un état des lieux de la façade est impératif. Le parpaing, bien que robuste, peut présenter des défauts de planéité qui se répercuteraient directement sur l'alignement final du bois.</p>
                ...
                <ul class="custom-list">
                    <li><strong>Planéité du mur :</strong> Passez une règle de 2 mètres sur la surface. Un écart supérieur à 5 mm doit être rectifié ou compensé lors de la pose de l'ossature via des cales de réglage.</li>
                    <li><strong>Étanchéité du support :</strong> Le mur doit être sain. Traces d'humidité importante ou remontées capillaires ? Traitez le problème à la source avant de "fermer" le mur derrière un bardage.</li>
                    <li><strong>Solidité des alvéoles :</strong> Le parpaing creux peut être fragile sur les bâtis anciens. Testez toujours la tenue d'une cheville avant de lancer le chantier en série.</li>
                </ul>

                <h2 id="materiel">Inventaire : quel matériel pour fixer du bois sur de l'agglo ?</h2>

                <p>L'outillage doit être adapté à la fois au travail du bois et à la dureté du béton. Voici ce qu'il faut prévoir pour 50 m² de façade (2 à 3 jours de chantier, 2 personnes recommandées).</p>

                <div class="table-wrapper">
                    <table class="content-table">
                        <thead>
                            <tr><th>Outillage nécessaire</th><th>Matériaux à prévoir</th></tr>
                        </thead>
                        <tbody>
                            <tr><td><strong>Perforateur haute performance</strong></td><td>Tasseaux bois Classe 3 (27×40 mm minimum)</td></tr>
                            <tr><td><strong>Niveau laser</strong> (ou à bulle)</td><td>Chevilles à frapper longues (100 à 140 mm)</td></tr>
                            <tr><td><strong>Scie à onglet radiale</strong></td><td>Vis inox A2 (milieu standard) ou A4 (bord de mer)</td></tr>
                            <tr><td><strong>Visseuse à choc</strong></td><td>Grilles anti-rongeurs et bandes EPDM</td></tr>
                        </tbody>
                    </table>
                </div>
                ...
                <p>C'est le point critique de toute pose sur agglo. Les chevilles à expansion simples risquent d'éclater l'alvéole sous l'effet de la pression. Privilégiez les <strong>chevilles à frapper</strong> ou les <strong>chevilles rallongées à collerette</strong> : elles traversent le tasseau et s'ancrent dans la partie pleine du bloc, garantissant une résistance à l'arrachement efficace face aux charges de vent.</p>

                <p><strong>Le collage est formellement exclu.</strong> Il ne permet pas de créer la lame d'air indispensable à la pérennité du bois, et les mouvements hygrothermiques arracheraient rapidement les points de colle sur un support minéral brut. Seule la fixation mécanique sur ossature est conforme au DTU 41.2.</p>

                <h2 id="ossature">Étape 1 : fixer l'ossature bois (les tasseaux) sur le parpaing</h2>

                <p>L'ossature constitue la structure porteuse du bardage. Son rôle est de maintenir les lames tout en ménageant la circulation d'air derrière elles — condition sine qua non pour la durabilité du bois.</p>
                ...
                <ol style="margin-bottom: 20px; padding-left: 20px;">
                    <li><strong>Traçage :</strong> Marquez l'emplacement des tasseaux tous les 60 cm (entraxe standard DTU).</li>
                    <li><strong>Perçage :</strong> Percez à travers le bois directement dans le parpaing avec le perforateur.</li>
                    <li><strong>Fixation :</strong> Insérez la cheville à frapper et verrouillez. Contrôlez le niveau de chaque tasseau.</li>
                    <li><strong>Joints de drainage :</strong> Laissez un espace de 10 mm entre deux tasseaux mis bout à bout verticalement pour permettre l'écoulement de l'eau de condensation.</li>
                </ol>

                <h3>Pose verticale ou horizontale : quel impact sur l'ossature ?</h3>

                <p>Pour un bardage posé <strong>horizontalement</strong> (le classique), les tasseaux sont verticaux. Pour un bardage posé <strong>verticalement</strong> (effet contemporain), il faut installer une <strong>double ossature</strong> (contre-lattage croisé) afin de garantir que l'air circule de bas en haut sans obstruction. Ne pas respecter cette règle annihile la ventilation et condamne le bois à moyen terme.</p>

                <h2 id="pare-pluie">Étape 2 : installer le pare-pluie et créer la lame d'air</h2>

                <p>Sur un mur en parpaing, la gestion de l'humidité est le facteur numéro un de réussite. Un mur humide sous un bardage mal ventilé, c'est la garantie de moisissures en moins de cinq ans.</p>
                ...
                <ul class="custom-list">
                    <li><strong>Le pare-pluie :</strong> Même sur un support lourd comme le parpaing, la pose d'un pare-pluie est vivement conseillée dans les régions exposées aux vents dominants. Il protège le mur des infiltrations accidentelles sans bloquer la vapeur d'eau.</li>
                    <li><strong>La grille anti-rongeur :</strong> Fixée en pied de mur, elle ferme l'entrée de la lame d'air contre les souris et les guêpes tout en laissant passer l'air librement.</li>
                    <li><strong>La bande EPDM :</strong> Une bande de caoutchouc noir posée sur chaque tasseau protège le bois de l'ossature de l'humidité stagnante qui s'infiltre entre les lames.</li>
                </ul>

                <h2 id="pose-lames">Étape 3 : la pose des lames de bardage et les finitions</h2>

                <p>Une fois l'ossature prête, la pose du bois peut commencer. C'est l'étape la plus visible — et celle où les petits détails font toute la différence sur la longévité du résultat.</p>
                ...
                <ul class="custom-list">
                    <li><strong>Le départ :</strong> Installez la première lame à 15–20 cm du sol pour éviter les remontées d'eau et les projections de boue.</li>
                    <li><strong>L'emboîtement :</strong> Placez toujours la languette vers le haut et la rainure vers le bas pour que l'eau de pluie ne s'accumule pas dans le profilé.</li>
                    <li><strong>Le vissage :</strong> Utilisez deux vis inox par point d'appui dès que la lame dépasse 125 mm de largeur, pour éviter le tuilage (courbure dans le temps).</li>
                    <li><strong>Le jeu de dilatation :</strong> Ne serrez jamais les lames bord à bord. Un léger jeu est indispensable pour absorber les mouvements hygrothermiques du bois.</li>
                </ul>
                ...
                <p>Pour les angles, deux solutions s'offrent à vous : la <strong>coupe d'onglet</strong> (esthétique mais exigeante techniquement) ou le <strong>profilé d'angle en aluminium</strong>. Cette seconde option est recommandée pour sa durabilité et sa capacité à absorber les légères dilatations du bois sans rouvrir. Autour des fenêtres et des portes, prévoyez des baguettes de finition et veillez à ne jamais obstruer la circulation d'air en pied d'allège.</p>
                ...
                <div id="ux-tool" class="ux-tool-container">
                    ...
                    <div id="step-2" class="ux-step">
                        ...
                        <div class="ux-options">
                            <button class="ux-btn" onclick="saveAnswer(2, 'zero')">Zéro entretien (je veux oublier)</button>
                            <button class="ux-btn" onclick="saveAnswer(2, 'peu')">Un traitement tous les 5–7 ans, ça va</button>
                        </div>
                    </div>
                ...
                <p>Le parpaing est éternel, mais le bois ne l'est pas sans un minimum de rigueur au moment du choix. L'essence détermine la durabilité naturelle, la stabilité dimensionnelle et le rythme d'entretien.</p>

                <ul class="custom-list">
                    <li><strong>Douglas (Classe 3) :</strong> Le standard du marché français. Son cœur (duramen) est naturellement imputrescible. Excellent rapport qualité/prix, disponible partout en scierie.</li>
                    <li><strong>Mélèze :</strong> Très dense et naturellement résistant à l'humidité. Idéal pour les poses en altitude ou dans les régions à pluviométrie élevée.</li>
                    <li><strong>Red Cedar :</strong> Très stable dimensionnellement, il résiste aux chocs hygrothermiques. Plus onéreux, mais quasi-zéro entretien sur 20 ans.</li>
                    <li><strong>Bois brûlé (Shou Sugi Ban) :</strong> Technique ancestrale japonaise qui carbonise superficiellement le bois pour le rendre insensible aux UV, aux insectes et à l'humidité. Esthétique unique, durabilité exceptionnelle sans traitement chimique.</li>
                </ul>

                <h2 id="erreurs">Les 3 erreurs critiques qui font pourrir un bardage sur agglo</h2>

                <ul class="custom-list">
                    <li><strong>Erreur 1 — L'absence de lame d'air :</strong> Si l'air ne circule pas, l'humidité reste prisonnière entre le parpaing et le bois. Moisissures et pourrissement apparaissent en moins de cinq ans. C'est la cause n°1 des bardages ratés.</li>
                    <li><strong>Erreur 2 — Les vis standard :</strong> Le bois extérieur oxyde l'acier ordinaire. Des coulures noires apparaîtront sur vos lames avant même que les vis ne commencent à casser. Vis inox A2 obligatoire, A4 en milieu marin.</li>
                    <li><strong>Erreur 3 — Brider les lames :</strong> Le bois gonfle en hiver et se rétracte en été. Des lames posées sans jeu de dilatation gondolent, se fendillent ou arrachent leurs fixations. Ce mouvement est normal et prévisible — anticipez-le.</li>
                </ul>

                <h2 id="faq">FAQ, Questions fréquentes</h2>

                <h3>Comment fixer du bois sur parpaing sans vis ?</h3>
                <p>C'est impossible pour un bardage extérieur durable. Des systèmes de clips existent sur le marché, mais ils doivent eux-mêmes être mécaniquement fixés dans l'ossature. Le collage direct sur parpaing est formellement exclu par le DTU 41.2.</p>

                <h3>Peut-on poser un bardage bois sur un mur déjà enduit ?</h3>
                <p>Oui, à condition que l'enduit soit sain, adhérent et ne se décolle pas. Il faudra utiliser des chevilles plus longues pour compenser l'épaisseur de l'enduit et atteindre le parpaing avec un ancrage suffisant. Un test de traction préalable sur quelques points est conseillé.</p>

                <h3>Quel est le bardage bois le plus résistant ?</h3>
                <p>Le Robinier (faux-acacia) est l'essence naturellement la plus durable en Europe, mais sa disponibilité en lames calibrées reste limitée. Le Douglas traité en Classe 3 ou 4 demeure la référence la plus utilisée en France pour sa stabilité sur support minéral et son excellente disponibilité en négoce.</p>

                <h3>Faut-il un permis de construire pour poser un bardage bois ?</h3>
                <p>Dans la plupart des cas, une simple déclaration préalable de travaux suffit dès lors que le bardage modifie l'aspect extérieur de la construction. En zone protégée (ABF, secteur sauvegardé) ou pour un bâtiment classé, vérifiez systématiquement les règles auprès de votre mairie avant de commander les matériaux.</p>
            ...
            <div class="author-box-bottom">
                ...
                <div class="author-box-content">
                    ...
                    <p>Avec plus de 20 ans d'expérience sur les chantiers de ravalement et d'isolation, Philippe maîtrise la pose de bardage bois sur tous types de supports maçonnés, du parpaing au béton banché.</p>
            ...
            <div class="conclusion-box">
                ...
                <p>Avant de vous lancer, une évaluation du support (planéité, humidité, état des alvéoles) par un artisan qualifié vous évitera les mauvaises surprises en cours de chantier.</p>

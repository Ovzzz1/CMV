...
<style>
/* Styles additionnels spécifiques pour les vidéos et l'outil UX */
.video-container { position: relative; padding-bottom: 56.25%; height: 0; margin: 2rem 0; background: #000; border-radius: 8px; overflow: hidden; }
    ...
    <div class="article-layout">
        ...
        <div class="article-container">
            ...
            <p class="article-intro">
                Vous souhaitez transformer votre <span class="hashtag">#toit</span> en un espace nourricier ? Créer un <span class="hashtag">#potager</span> en hauteur est un superbe <span class="hashtag">#projet</span> pour renouer avec la nature en milieu <span class="hashtag">#urbain</span>. Cependant, cultiver sur un toit-terrasse impose des contraintes uniques : vent fort, soleil direct, et surtout, le poids. Oubliez la théorie compliquée : voici un plan d'action concret, simple et direct pour installer votre potager, choisir le bon matériel et anticiper les pires galères.
            </p>
            ...
            <div class="article-content">
                ...
                <img src="<?php echo BASE_URL; ?>image/potager-toit-2.webp" alt="Vérification de la portance d'un toit plat avant l'installation de bacs de culture" loading="lazy" style="width: 100%; border-radius: 8px; margin-bottom: 1.5rem;">
                ...
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/UUvLkYvu_mM" title="Alternative : potager sur toit de garage" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                ...
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/vX_uGsGbLJs" title="Tutoriel carré potager 1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/F4G6Er-lxEU" title="Tutoriel carré potager 2" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                ...
                <img src="<?php echo BASE_URL; ?>image/potager-toit-3.webp" alt="Système de goutte-à-goutte installé dans un carré potager sur un toit" loading="lazy" style="width: 100%; border-radius: 8px; margin-bottom: 1.5rem;">
